<%@ Page Title="" Language="C#" MasterPageFile="~/Eshopper/Home.master" AutoEventWireup="true" CodeFile="register.aspx.cs" Inherits="Eshopper_register" %>
				...
				<div class="col-sm-4">
					<div class="signup-form"><!--sign up form-->
						<h2>New User Registration!</h2>
                            ...
                            <br />
                            <asp:Button ID="btn_register" BackColor="#FE980F" ForeColor="#FFFFFF" ValidationGroup="r" runat="server" Text="Register" OnClick="btn_register_Click" />
