...
public partial class Eshopper_auction : System.Web.UI.Page
{
        ...
        foreach (string i in ai)
        {
            ...
            if (count2 >= 1)
            {
                ...
                while (dr1.Read())
                {
                    ...
                    sb.Append("<a href='productdetails.aspx?productid=" + dr1[0].ToString() + "&auction=yes' class='btn btn-default add-to-cart'>View</a>");
                    sb.Append("</div>");
                    sb.Append("<br />");
                    sb.Append("</div>");
                    sb.Append("</div>");
